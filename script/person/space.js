setTimeout(function () {
	...
	var tel1 = $('.tel1>button');
	var tel2 = $('.tel2>button');
	var tel3 = $('.tel3>button');
	var telOff = $('.telPopup h3 i');
	...
	var email1 = $('.email1>button');
	var email2 = $('.email2>button');
	var emailOff = $('.emailPopup h3 i');
	email1.on('click', function () {
		$(this).parents('.email1').hide();
		$(this).parents('.email1').siblings('.email2').show();
	});
	email2.on('click', function () {
		$(this).parents('.email2').siblings('.email1').show();
		$(this).parents('.email2').hide();
		$(this).parents('.emailPopup').hide();
		$maskLayer.hide();
	});
	emailOff.on('click', function () {
		$(this).parents('.emailPopup').hide();
		email1.parent().show();
		email2.parent().hide();
		$maskLayer.hide();
