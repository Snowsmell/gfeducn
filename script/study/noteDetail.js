...
$(function() {
    ...
    $(".leftR").click(function() {
        ...
        $(".chart ul").append("<li class='chartLeft'><dl><dt><img src='../../images/study/jzh-photo02.png'><p>+追问</p></dt><dd><div class='chartContain'><p>" + mainstr + "</p></div><em>2017-5-1 16:23</em></dd></dl></li>");

    })
    $(".rightR").click(function() {
        var mainstr = $(this).siblings("input").val();
        $(".chart ul").append("<li class='chartRight'><dl><dt><img src='../../images/study/jzh-photo02.png'><p>+追问</p></dt><dd><div class='chartContain'><p>" + mainstr + "</p></div><em>2017-5-1 16:23</em></dd></dl></li>");
